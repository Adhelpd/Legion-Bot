...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/user/updateAdmin',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.updateUserAdmin)),

            function UserController_updateUserAdmin(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.updateUserAdmin.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, 201, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/unit',
            ...
            ...(fetchMiddlewares<RequestHandler>(UnitController.prototype.getAllUnits)),

            function UnitController_getAllUnits(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getAllUnits.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, 201, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/unit/:id',
            ...(fetchMiddlewares<RequestHandler>(UnitController)),
            ...(fetchMiddlewares<RequestHandler>(UnitController.prototype.searchUserAdmin)),

            function UnitController_searchUserAdmin(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
            ...
            try {
              ...
              const promise = controller.searchUserAdmin.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, 201, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/unit/search/:shorthand',
            ...(fetchMiddlewares<RequestHandler>(UnitController)),
            ...(fetchMiddlewares<RequestHandler>(UnitController.prototype.searchShorthand)),

            function UnitController_searchShorthand(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.searchShorthand.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, 201, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/unit/update/editor',
            ...(fetchMiddlewares<RequestHandler>(UnitController)),
            ...(fetchMiddlewares<RequestHandler>(UnitController.prototype.updateUserEditor)),

            function UnitController_updateUserEditor(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.updateUserEditor.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, 201, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/unit/update/adminEditor',
            ...(fetchMiddlewares<RequestHandler>(UnitController)),
            ...(fetchMiddlewares<RequestHandler>(UnitController.prototype.adminUpdateUserEditor)),

            function UnitController_adminUpdateUserEditor(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.adminUpdateUserEditor.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, 201, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/unit/:requestBody',
            ...(fetchMiddlewares<RequestHandler>(UnitController)),
            ...(fetchMiddlewares<RequestHandler>(UnitController.prototype.createUnit)),

            function UnitController_createUnit(request: any, response: any, next: any) {
            const args = {
